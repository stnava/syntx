    ...
    <div class="container">
        ...
        <section>
            ...
            <table class="prov-table">
                ...
                <tr><th>Fluid / Elastic Sigmas</th><td>fluid = <code>{float(prov['fluid_sigma']) if isinstance(prov['fluid_sigma'], (int, float)) or (isinstance(prov['fluid_sigma'], str) and prov['fluid_sigma'].replace('.','',1).isdigit()) else 2.0:.2f}</code>, elastic = <code>{float(prov['elastic_sigma']) if isinstance(prov['elastic_sigma'], (int, float)) or (isinstance(prov['elastic_sigma'], str) and prov['elastic_sigma'].replace('.','',1).isdigit()) else 0.05:.2f}</code></td></tr>
