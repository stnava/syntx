...
print("================================================================================")
print("             PEAK LARS TVF EVALUATION ON R16_R64 BENCHMARK                     ")
print("================================================================================")
print(f"Cortical Gray Matter (Class 2) Sym Dice : {d2_sym:.6f}  (Fixed: {d2_fixed:.4f}, Moving: {d2_moving:.4f})")
print(f"Deep Structures (Class 3) Sym Dice     : {d3_sym:.6f}  (Fixed: {d3_fixed:.4f}, Moving: {d3_moving:.4f})")
print(f"Parenchymal Brain (Class 2+3) Sym Dice : {d23_sym:.6f}  (Fixed: {d23_fixed:.4f}, Moving: {d23_moving:.4f})")
