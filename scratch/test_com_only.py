...
# Run registration with CoM initialization and 0 affine iterations
print("Running SyNTo (PyTorch) with 0 affine iterations...")
...
print(f"PyTorch SyN (CoM-only) DICE: {dice_torch:.4f}")
