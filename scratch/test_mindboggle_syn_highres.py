...
def run_mindboggle_syn_test_highres():
    ...
    # Resample images to 1.5mm spacing with linear interpolation (interp_type=4) for better structural representation
...
if __name__ == '__main__':
    run_mindboggle_syn_test_highres()
