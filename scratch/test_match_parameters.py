...
# 2. Run ANTs SyN with custom parameters
# default iterations in ANTs for SyNOnly is [100, 70, 50, 20]
print("Running ANTs SyN (SyNOnly)...")
...
# 3. Run Syntx PyTorch SyN with matching parameters
print("\nRunning Syntx PyTorch SyN (matching parameters)...")
