...
initial_mi = ants.image_mutual_information(fi, mi_affine)
print("Initial ANTs MI:", initial_mi)
...
print("\nRunning test with ADDING delta (opposite direction)...")
for step in range(10):
    ...
    with torch.no_grad():
        ...
        # Greedy composition with ADDING delta!
