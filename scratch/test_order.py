...
warped_default = ants.apply_transforms(fi, mi_affine, reg_pt['fwdtransforms'])
print("MI default order:", ants.image_mutual_information(fi, warped_default))

warped_reversed = ants.apply_transforms(fi, mi_affine, reg_pt['fwdtransforms'][::-1])
print("MI reversed order:", ants.image_mutual_information(fi, warped_reversed))
